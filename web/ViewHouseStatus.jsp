<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li  class="active"><a href="ViewHouseStatus.jsp">View House Status</a></li>
         ...
         <span align="center"><h1>House Status</h1></span>
...
String sql ="SELECT * FROM addghar";
rs = st.executeQuery(sql);
while(rs.next()){
%>
        <tr>
            <td><br><%=rs.getString("id") %><br></td>
            <td><br><%=rs.getString("status") %><br></td>
