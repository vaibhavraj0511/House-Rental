...
%>
    <body>
        ...
        <span align="center"><h1>Forgot Password</h1></span>
        
        <form action="ForgotPasswordCode.jsp" method="POST">
        ...
        <div class="container" align="center">
            ...
            <input type="password" placeholder="Enter New Password" id="psw" name="psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required><br>
            ...
            <div class="clearfix">
                <button type="submit" class="signupbtn">Forgot</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
